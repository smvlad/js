// изменения для задания 3.6, которые проиндексированы  Ниже строка удалена 3.9 №2
// изменения для задания 3.9  #1
// изменения для задания 3.6, которые проиндексированы  
// изменения для задания 3.6, которые не проиндексированы  Строка оставлена 3.9  #3
