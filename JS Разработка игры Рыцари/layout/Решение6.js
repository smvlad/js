...
let speed=7, speedorc=2, numAnimImgs = 5, bumpDistance=80;
...
class game {
	constructor () {
		...
		orc1= new orc("100px","600px","../media/Рыцари/_PNG_rever/1/","3_RUN_000",".png",1);
		orc2= new orc("300px","600px","../media/Рыцари/_PNG/2/","1_IDLE_000",".png",2);
		orc3= new orc("500px","600px","../media/Рыцари/_PNG/3/","1_IDLE_000",".png",3);
