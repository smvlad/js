...
class game {
	constructor () {
		...
		for (var i = 0; i < numtype1; i++) {
			orc1[i] = new orc("100px",bornline+"px","../media/Рыцари/_PNG/1/","3_RUN_000",".png",1);
		}
		for (var i = 0; i < numtype2; i++) {
			orc2[i] = new orc("300px",bornline+"px","../media/Рыцари/_PNG/2/","3_RUN_000",".png",2);
		}
		for (var i = 0; i < numtype3; i++) {
			orc3[i] = new orc("500px",bornline+"px","../media/Рыцари/_PNG/3/","3_RUN_000",".png",3);
		}
