...
let speed=7, speedorc=2, numAnimImgs = 5, bumpDistance=80, timetodie=1000, bornline=1200, screensize=800;
...
/////////////  получаем числовое значение координат
	...
	moveDown() {
		if (this.top<screensize+this.speed) {
			this.top+=this.speed;
			this.boxobject.style["top"]=this.top+"px";
		}		
	}
