...
class game {
	constructor() {
		...
		for (let i=0; i<10; i++) {                             //  создание кочек
			this.hilltop = get_random(600,800);
			hills[i] = new hill(this.hilltop,i*(gamepartWidth+80));
		}
		for (let i=0; i<8; i++) {                             //  создание гиен
			guenas[i] = new guena(downGr-gamepartHeight,(i+2)*(gamepartWidth+80));
		}
