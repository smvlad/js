...
//ссылка_на_кнопку.addEventListener()   чтобы появилась подсказка - прогнать скрипт для формирования ссылки 
ссылка_на_кнопку.addEventListener('click', newgame);

function newgame() {
	let ссылка_на_карты=document.getElementsByTagName('img');
	for (var i = 0; i < ссылка_на_карты.length; i++) {
		ссылка_на_карты[i].src = "карты/"+deck[i];
	}
}